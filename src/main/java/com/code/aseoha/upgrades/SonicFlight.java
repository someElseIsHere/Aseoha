...
//
//    public SonicFlight(UpgradeEntry entry, ConsoleTile tile, Class<? extends Subsystem> clazz) {
//        super(entry, tile, clazz);
//        tile.registerTicker(this);
//        this.random = new Random();
//    }
////public boolean isActive = this.isActivated();
//public static boolean SonicFlightActivate(ConsoleTile console) {
//    final boolean FlightFromSonic = console.is() && !console.isCrashing();
//    console.getUpgrade(SonicFlight.class).ifPresent((hads) -> {
//        if(hads.isActivated()){
//            if(HADSACTIVE) {
////                onEventPopup()
