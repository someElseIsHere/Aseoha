...
import com.code.aseoha.client.models.exteriors.BrackolinExterior;
...
public class BrackolinRender extends ExteriorRenderer<BrackolinTile> {
    public static ResourceLocation TEXTURE = new ResourceLocation("aseoha", "textures/exteriors/brackolin/brackolin.png");
    ...
    public static WorldText TEXT = new WorldText(0.35F, 0.20F, 0.003F, 16777215);
