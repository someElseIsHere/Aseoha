...
import com.code.aseoha.client.models.exteriors.RaniExterior;
...
public class RaniRender extends ExteriorRenderer<RaniTile> {
    public static ResourceLocation TEXTURE = new ResourceLocation("aseoha", "textures/exteriors/rani/rani.png");
