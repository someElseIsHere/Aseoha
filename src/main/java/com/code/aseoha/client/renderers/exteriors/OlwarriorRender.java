...
import com.code.aseoha.client.models.exteriors.OlwarriorExterior;
...
public class OlwarriorRender extends ExteriorRenderer<OlwarriorTile> {
    public static ResourceLocation TEXTURE = new ResourceLocation("aseoha", "textures/exteriors/olwarrior/olwarrior.png");
