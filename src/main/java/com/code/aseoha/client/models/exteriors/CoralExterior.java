...
public class CoralExterior extends ExteriorModel {
    ...
    public CoralExterior() {
        ...
        base.setPos(0.5F, 23.2F, 0.5F);
        base.texOffs(0, 0).addBox(-8.5F, -0.2F, -8.5F, 17.0F, 1.0F, 17.0F, 0.0F, false);
        base.texOffs(-1, 17).addBox(-8.0F, -0.5F, -8.0F, 16.0F, 1.0F, 16.0F, 0.0F, false);
        base.texOffs(0, 18).addBox(-7.5F, -0.8F, -7.5F, 15.0F, 1.0F, 15.0F, 0.0F, false);

        sides = new ModelRenderer(this);
        sides.setPos(-0.5F, 0.8F, -0.5F);
        base.addChild(sides);
        ...
        side1.texOffs(2, 68).addBox(1.0F, -23.0F, 0.2F, 11.0F, 22.0F, 1.0F, 0.0F, false);
        ...
        side1.texOffs(51, 0).addBox(1.0F, -30.0F, 0.0F, 10.0F, 7.0F, 1.0F, 0.0F, false);
        ...
        side2.texOffs(8, 70).addBox(-10.8F, -23.0F, -0.5F, 11.0F, 22.0F, 1.0F, 0.0F, false);
        ...
        side2.texOffs(55, 0).addBox(-9.8F, -30.0F, -0.7F, 9.0F, 7.0F, 1.0F, 0.0F, false);
        ...
        side3.texOffs(18, 35).addBox(-16.6F, -23.0F, -6.3F, 11.0F, 22.0F, 1.0F, 0.0F, false);
        ...
        side3.texOffs(52, 0).addBox(-15.6F, -30.0F, -6.5F, 10.0F, 7.0F, 1.0F, 0.0F, false);
        ...
        doorsleft.texOffs(43, 38).addBox(-6.0385F, -11.1692F, -0.2769F, 1.0F, 29.0F, 1.0F, 0.0F, false);
        ...
        doorsleft.texOffs(30, 34).addBox(-5.0385F, -4.1692F, -1.0769F, 5.0F, 22.0F, 1.0F, 0.0F, false);
        ...
        doorsleft.texOffs(63, 0).addBox(-5.0385F, -11.1692F, -1.2769F, 5.0F, 7.0F, 1.0F, 0.0F, false);
        doorsleft.texOffs(63, 48).addBox(-5.0385F, -3.1692F, -1.5769F, 5.0F, 6.0F, 2.0F, 0.0F, false);
        ...
        doorsright.texOffs(41, 65).addBox(0.7727F, -3.9545F, -1.0545F, 5.0F, 22.0F, 1.0F, 0.0F, false);
        ...
        doorsright.texOffs(62, 0).addBox(0.7727F, -10.9545F, -1.2545F, 5.0F, 7.0F, 1.0F, 0.0F, false);

        handle2 = new ModelRenderer(this);
        handle2.setPos(5.8727F, 2.1455F, 0.8455F);
        doorsright.addChild(handle2);
        handle2.texOffs(0, 0).addBox(-1.0F, -4.0F, -0.8F, 2.0F, 4.0F, 2.0F, -0.9F, false);
        handle2.texOffs(0, 0).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 2.0F, 2.0F, -0.9F, false);
        handle2.texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, -0.9F, false);

        corners = new ModelRenderer(this);
        corners.setPos(-0.5F, 0.8F, -0.5F);
...
public void renderBoti(ExteriorTile exterior, float scale, MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float alpha) {
        if (exterior.getBotiWorld() != null && exterior.getMatterState() == EnumMatterState.SOLID && exterior.getOpen() != EnumDoorState.CLOSED) {
            ...
            info.setRenderPortal((matrix, buf) -> {
                ...
                this.side2.render(matrix, buf.getBuffer(RenderType.entityCutout(ModernPoliceBoxExteriorRenderer.TEXTURE)), packedLight, packedOverlay);
                matrix.popPose();
            });
            info.setRenderDoor((matrix, buf) -> {
                matrix.pushPose();
                matrix.scale(1.1F, 1.1F, 1.1F);
                this.doorsleft.render(matrix, buf.getBuffer(RenderType.entityCutout(ModernPoliceBoxExteriorRenderer.TEXTURE)), packedLight, packedOverlay);
                matrix.popPose();
            });
